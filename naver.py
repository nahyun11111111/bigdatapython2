...
try:
    ...
    for item in webtoon_items:
        try:
            ...
            thumbnail_img = item.find_element(By.CSS_SELECTOR, '#content > div:nth-child(1) > ul > li:nth-child(3) > a > div > img') # 예시 셀렉터
            ...
            title_element = item.find_element(By.CSS_SELECTOR, '#content > div:nth-child(1) > ul > li:nth-child(3) > div > a > span > span') # 예시 셀렉터
            title = title_element.text if title_element else 'N/A'

            # 작가명 추출
            # 작가명은 보통 a 또는 span 태그의 텍스트입니다.
            # 작가명 요소를 감싸는 셀렉터와 작가명 태그의 셀렉터를 찾습니다.
            artist_element = item.find_element(By.CSS_SELECTOR, '#content > div:nth-child(1) > ul > li:nth-child(3) > div > div.ContentAuthor__author_wrap--fV7Lo > a') # 예시 셀렉터 (여러 작가일 수 있음)
            ...
            rating_element = item.find_element(By.CSS_SELECTOR, '#content > div:nth-child(1) > ul > li:nth-child(2) > div > div > span > span') # 예시 셀렉터
